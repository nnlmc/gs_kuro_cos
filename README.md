> 禁止🚫使用本项目进行任何形式收费，包括但不限于售卖、付费代装、付费部署、付费托管、付费群/会员/订阅/套餐捆绑、赞助解锁、付费授权或任何变相收费。
>
> 本项目采用 **Non-Commercial Copyleft Public Source License 1.0（类 GPLv3 非商业公共源码许可证）**：可以免费下载、使用、修改和分享；使用、修改或分发后必须继续公开源码；禁止任何形式收费。
